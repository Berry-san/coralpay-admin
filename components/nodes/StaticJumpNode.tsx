...
const StaticJumpNode = ({ data, id }: { data: any; id: string }) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="bg-purple-500 text-white rounded-lg px-4 py-3 shadow-lg min-w-[200px]">
        ...
        <div className="text-xs opacity-90">
          Leaf : {data.leafText || 'My new leaf'}
        </div>
      </div>
      {data.hasTopHandle && (
        <Handle
